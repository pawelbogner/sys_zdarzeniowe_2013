...
**
** Created: Sun Dec 15 19:22:14 2013
...
public:
    ...
    void setupUi(QWidget *SerwerMain)
    {
        ...
        formLayoutWidget->setGeometry(QRect(20, 30, 160, 80));
        ...
        formLayoutWidget_3->setGeometry(QRect(10, 20, 231, 181));
        ...
        se_re = new QComboBox(formLayoutWidget_3);
        se_re->setObjectName(QString::fromUtf8("se_re"));

        formLayout_3->setWidget(3, QFormLayout::FieldRole, se_re);
